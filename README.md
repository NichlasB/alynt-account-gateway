...
- Branded HTML account email templates with WordPress-native Visual/Text editors, preview and test-send tools, and an unsaved-change guard that also protects against accidental navigation.
