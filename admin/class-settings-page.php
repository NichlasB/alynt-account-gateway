...
class ALYNT_AG_Settings_Page {
	 ...
	 * @return void
	 */
	private function render_diagnostics_operational_snapshot( $diagnostic_events, $verification_logs, $webhook_logs ) {
	 ...
	 * @return array<int,array{label:string,status:string,count:int,message:string}>
	 */
	private function diagnostics_operational_snapshot_items( $diagnostic_events, $verification_logs, $webhook_logs ) {
