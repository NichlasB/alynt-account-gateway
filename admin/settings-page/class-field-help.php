...
class ALYNT_AG_Settings_Page_Field_Help extends ALYNT_AG_Settings_Page_Component {
	...
	public function settings_field_help_text( $key ) {
		...
		$help = array(
			...
			'woocommerce_saved_methods_enabled'   => __( 'Optional and disabled by default. Show the Payment Methods dashboard navigation, saved-method summary, and related shortcuts. WooCommerce continues to handle secure payment data and direct endpoint behavior.', 'alynt-account-gateway' ),
