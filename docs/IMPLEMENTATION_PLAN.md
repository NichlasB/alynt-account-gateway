...
- [x] Publish and updater-verify a patch release after owner approval.
...
- GitHub release `v1.1.30` was published from commit `09bf9e6`: `https://github.com/NichlasB/alynt-account-gateway/releases/tag/v1.1.30`.
- GitHub Quality workflows passed for `master` run `31210985717` and tag run `31210993194` across PHP 7.4 and PHP 8.3.
...
- The inspected release-style ZIP contains `116` runtime files, no development files or backslash archive entries, and has SHA-256 `44C6602E2DA5CA1741AED024AE2A786F45E0347A670DAFD4DC653345CADCA470`.
