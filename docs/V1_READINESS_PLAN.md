...
| Publication state | `v0.1.107` committed, tagged, pushed, published, public ZIP inspected, installed on `hbf-staging` through Alynt Plugin Updater, and all five account-email templates resent through the site mail path | Mailbox confirmation pending |
...
| `P1-005` | 1 / 3 | Low | Account-email body text felt too small during real mailbox review after logo correction. `v0.1.106` did not visibly change the real mailbox because the client ignored the wrapper/media-query approach. | Product owner | Confirm the resent `v0.1.107` mailbox rendering after inline paragraph/list-item body sizing was released and installed. | Focused and full candidate tests, PHPCS, syntax sweep, build, POT regeneration, package inspection, updater install `0.1.106 -> 0.1.107`, installed-file verification, and five resent account-email templates | Open mailbox confirmation |
