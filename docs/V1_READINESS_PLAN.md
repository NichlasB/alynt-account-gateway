...
| Remaining coverage | Address/account POST validation, saved-payment actions, delegated nonce/error handling, unavailable endpoint fallback, role/admin policy recheck, and extension compatibility remain open | Open |
