...
class FrontendMessagesTest extends TestCase {
	...
	public function test_resend_error_returns_known_message_and_neutral_fallback() {
		...
		$this->assertSame( 'Too many confirmation email requests. Please wait for the resend window before trying again.', $messages->resend_error( 'alynt_ag_rate_limited' ) );
